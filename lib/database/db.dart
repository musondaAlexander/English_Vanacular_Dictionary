...
class DictionaryDatabase {
  ...
  Future<List> getEnglishWords() async {
    ...
    return await db.query('dictionary', columns: ["word"], orderBy: "word ASC");
  }

  Future<List> getMalayalamWordsWithDefinition() async {
    Database db = await instance.database;

    return await db.query('dictionary', orderBy: "definition ASC");
  }

  Future<List> getChewaWordsWithDefinition() async {
    Database db = await instance.database;

    return await db.query('chewa', orderBy: "definition ASC");
  }
}
